    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: isSelected ? Theme.of(context).colorScheme.primary : Colors.transparent, width: isSelected ? 3 : 0),
        ...
        return ClipRect(
          child: OverflowBox(
            ...
            child: Transform.translate(
              ...
              child: Image.asset(assetPath, width: cellW * 4, height: cellH * 4, fit: BoxFit.fill,
